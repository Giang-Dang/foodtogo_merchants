...
import 'package:foodtogo_merchants/widgets/order_customer.dart';
import 'package:foodtogo_merchants/widgets/order_order_details.dart';
import 'package:foodtogo_merchants/widgets/order_shipper.dart';
import 'package:foodtogo_merchants/widgets/order_status_widget.dart';
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            //Order details
            const SizedBox(height: 20),
            OrderOrderDetails(order: widget.order),
